...
function LoadProcess(process){
    ...
    //if(document.getElementById("processing_block").innerHTML == ''){
    //    document.getElementById("processing_block").innerHTML = "<span style='border:solid 1px gray'>" + process + "</span>";            
    //}
    //else{
    //    document.getElementById("processing_block").innerHTML = process + "<br/><span style='border:solid 1px gray'>" + //document.getElementById("processing_block").innerHTML + "</span>";            
    //}
}
